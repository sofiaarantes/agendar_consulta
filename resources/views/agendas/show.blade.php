        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Agenda Detalhes</h4>
                @if($slots->isEmpty())
                    <div class="alert alert-info">Nenhum slot encontrado para este bloco.</div>
                @else
                    <table class="table table-bordered text-center align-middle">
                        ...
                        <tbody>
                            @foreach($slots as $slot)
                                <tr>
                                    <td>{{ \Carbon\Carbon::parse($slot->data)->format('d/m/Y') }}</td>
                ...
                @endif
                <a href="{{ route('agendas.indexGeral') }}" class="btn btn-secondary mt-3">Voltar</a>
            </div>
