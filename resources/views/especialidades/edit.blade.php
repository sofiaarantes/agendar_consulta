        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Editar Especialidade</h4>
                {{-- Mensagem de sucesso --}}
                @if(session('success'))
                ...
                <div class="card-body">
                    <form action="{{ route('especialidades.update', $especialidade->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="nome">Nome da Especialidade</label>
                            <div class="col-sm-10">
                                <input type="text" id="especialidade" name="especialidade" class="form-control" value="{{ old('especialidade', $especialidade->especialidade) }}" required/>
                            </div>
                        </div>
