        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <h4 class="fw-bold py-3 mb-4"> Gerenciar Especialidades</h4>
                    ...
                    <div class="card">
                        ...
                        <h5 class="mb-0">Especialidades Cadastradas</h5>
                        <a href="{{ route('especialidades.create') }}" class="btn btn-success btn-sm">Nova Especialidade</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach($especialidades as $especialidade)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('especialidades.edit', $especialidade->id) }}" class="btn btn-sm btn-primary">Editar</a>
