        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Médicos/</span> Autenticar Médico</h4>
                {{-- Mensagem de sucesso --}}
                @if(session('success'))
              ...
              @if($medicos->isEmpty())
                  <div class="alert alert-info text-center">
                      Nenhum usuário encontrado para autenticação.
                  </div>
              @else
                                  ...
                                  <tr>
                                      <td>
                                          <img src="{{ $medico->usuario->profile_photo_path 
                                                      ? asset('storage/' . $medico->usuario->profile_photo_path) 
                                                      : asset('assets/img/foto_padrao.jpg') }}" 
                                              alt="Foto de {{ $medico->usuario->name }}" 
                                      ...
                                      <td>
                                        ...
                                        <form action="{{ route('medicos.aprovar') }}" method="POST" style="display:inline-block;" class="mt-1">
                                            @csrf
                                            <input type="hidden" name="medico_id" value="{{ $medico->id }}">
