        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pacientes/</span> Gerenciar Pacientes</h4>
                {{-- Mensagem de sucesso --}}
                @if(session('success'))
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ $paciente->usuario->profile_photo_path 
                                                        ? asset('storage/' . $paciente->profile_photo_path) 
                                        ...
                                        <td>
                                            <form action="{{ route('pacientes.destroy', $paciente->id) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este usuário?');" class="mt-1">
                                                @csrf
                                                @method('DELETE')
